...
const routes = [
  {
    path: '/', component: DefaultLayout, children: [
      ...
      { path: '/equipment/update/:id', name: 'UpdateEquipment', component: UpdateEquipmentView, props: true },
      ...
      { path: '/ubication/update/:id', name: 'UpdateUbication', component: UpdateUbicationView, props: true },
      ...
      { path: '/state/update/:id', name: 'UpdateState', component: UpdateStateView, props: true },
      ...
      { path: '/movement/update/:id', name: 'UpdateMovement', component: UpdateMovementView, props: true },
      ...
      { path: '/income-type/update/:id', name: 'UpdateIncomeType', component: UpdateIncomeTypeView, props: true },
      ...
      { path: '/inventory/update/:id', name: 'UpdateInventory', component: UpdateInventoryView, props: true },
      ...
      { path: '/inventory-review/update/:id', name: 'UpdateInventoryReview', component: UpdateInventoryReviewView, props: true },
      ...
      { path: '/responsible/update/:id', name:'UpdateResponsible', component: UpdateResponsibleView, props: true},
