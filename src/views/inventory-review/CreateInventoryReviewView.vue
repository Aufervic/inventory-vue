...
async function crearRevisionInventario() {
    try {
        ...
        <div v-else>
            <form @submit.prevent="crearRevisionInventario">
                ...
                <div class="form-check mb-3">
                    <input type="checkbox" id="encontrado" class="form-check-input" v-model="form.encontrado"
                        required />
                ...
                <div class="form-check mb-3">
                    <input type="checkbox" id="correccion-datos" class="form-check-input"
                        v-model="form.correccion_datos" required />
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id="fecha-revision" class="form-control" v-model="form.fecha_revision"
                        required />
                    <!--
